/**
 * @file AutoListView.java
 * @package com.uoiopo.uoiopolibrary.autolistview
 * @create 11 11, 2013
 * @author zenghui
 * @description An ListView support (a) Pull down to refresh, (b) auto load more.
...
//			mFooterView.show();
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		...
		if(mEnablePullLoad && scrollState == OnScrollListener.SCROLL_STATE_IDLE && (lastVisibileItem+1) == mTotalItemCount){
