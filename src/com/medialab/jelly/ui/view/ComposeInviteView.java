...
public class ComposeInviteView extends FullCardView{
	...
	public ComposeInviteView(Activity paramActivity,
...
//		this.imageView.setImageResource(R.drawable.bottom_of_stack_image);
		
		SharedPreferences sp = UTools.Storage.getSharedPreferences(paramActivity, UConstants.BASE_PREFS_NAME);
		String inviteCardUrl = sp.getString(UConstants.INVITE_CARD_URL, "");
		...
		this.inviteButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				MobclickAgent.onEvent(getContext(), UMengEventID.EDIT_INVITE_FRIEND_CARD_INVITE);
